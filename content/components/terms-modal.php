<div id="termsModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" aria-hidden="true">
  <div class="modal-header">
	<h4 class="content-heading4" id="modal-title">Terms & Conditions</h4>
  </div>
  <div class="modal-body">
	<div class="row-fluid">
		<div class="span10 offset1">
			  <p>
				This site is owned and maintained by <a href="about-us.php?t=t1" target="_blank">JobFair-Online.Net Staffing Solutions, Inc.</a> with the assistance and cooperation of <a href="about-us.php?t=t2" target="_blank">Service Resources, Inc.</a> and <a href="about-us.php?t=t3" target="_blank">Central Services Integrated Cooperative</a>. These entities do not charge any fee or amount from job applicants or employers for their utilization of the facilities provided in this website.  The maintainers of the site reserve the right to refuse or limit access to the site for any reason not contrary to law.</p>
