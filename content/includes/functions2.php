...
function getSearchBar(){
	if(file_exists("components/admin-navbar.php")){
		return $content = file_get_contents('components/admin-navbar.php', true);
	}
	else
		return "Error: Unable to load the admin-navbar file!";
}

function getApplicantNavBar(){
	if(file_exists("components/applicant-navbar.php")){
		return $content = file_get_contents('components/applicant-navbar.php', true);
	}
	else
		return "Error: Unable to load the applicant-navbar file!";
}

function getEmployerNavBar(){
	if(file_exists("components/employer-navbar.php")){
		return $content = file_get_contents('components/employer-navbar.php', true);
	}
	else
		return "Error: Unable to load the employer-navbar file!";
}
