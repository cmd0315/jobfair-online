...
if(isset($_GET['jobPositions'])){
	...
	$jPositions = json_decode($jobPositions);
	$jCount = 0;
	...
	$newFilteredApplicants = array_unique($newFilteredApplicants); //remove duplicate entries based on different table searches
